...
# \- LCD synced to actual PC volume via UART — stays accurate regardless of

# &#x20; what changed the volume (knob, keyboard, Windows mixer)

# \- Companion tray app (Windows) runs silently in the background,

# &#x20; optional run-on-startup via system tray menu
